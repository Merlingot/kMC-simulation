...
sym6 = False, sym3 = False, atoms = None, sb2=None, sb4 = None, unid = None):
    ...
    kArgs :
        ...
        # sb2 (Tuple(int) or int)   : id numbers of sites occupied by sb2 (DONT USE THIS)
...
def showConfig(process, location = None):
    """
    Shows the configuration before a process and after.
    Args:
        process (Class - Process)
    KArgs:
        location  (str) : relative / absolute path to directory where to save the figure
    Returns:
        matplotlib.pyplot.Figure
    """
    lattice = generateLattice((5,3,1))
    ...
    if location:
        plt.savefig(str(location), format = "eps", transparent = True )
