...
from pkg.includes.genProc import createProcess, showConfig
...
# # Edge Zigzag
#
# # b = createProcess('Separation Sb4 zigzag A', 'molecule separation', activation_energy = 1e-2, sb4 = 0, shell=1,
