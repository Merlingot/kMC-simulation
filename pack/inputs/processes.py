...
# 0 lien
list_of_processes += createProcess("D_a_0", 'diffusion', shells= 1,
...
# 2 liens
lien2  = []
lien2 += createProcess("D_a_2", 'diffusion', shells = 1,
...
sb4 = 0, shells = 1,  new_sites=(0,1,3,5))
sep += createProcess('S_246', 'molecule separation', activation_energy = 1e-3,
sb4 = 0, shells = 1,  new_sites=(0,2,4,6))
# Edge Zigzag
# Edge Armchair
sep += createProcess('Sep_chaiseI', 'molecule separation',
activation_energy = 1e-3, sb4 = 0, shells=1, atoms = (15,17), new_sites=(1,4,5,6), sym6=True)
